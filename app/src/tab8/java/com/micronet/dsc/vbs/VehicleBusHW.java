...
class VehicleBusHW {
    ...
    public static class CANHardwareFilter  extends CanbusHardwareFilter {
...
*/
        ...
        public static CanbusHardwareFilter[] upcast(CANHardwareFilter[] canHardwareFilters) {
        ...
        public static int[] createTypesArray(CANFrameType type, int length) {
            int[] types = new int[length];
            for (int i = 0; i < length; i++) {
                types[i] = (type == CANFrameType.EXTENDED ?
                        CanbusHardwareFilter.EXTENDED :
                        CanbusHardwareFilter.STANDARD);
            }
            return types;
        }
...
*/
        public CANHardwareFilter(int[] ids, int mask, CANFrameType type) {
